...
def fill_trade_embed_fields(
    ...
    Handles embed limits and shortens content if necessary.
    ...
    is_admin: bool
        If `True`, display the user ID of the traders.
    """
    embed.clear_fields()
    ...
    embed.add_field(
        ...
        value=(
            f"**{trader1.coins} {trader1_plural}**\n\n"
            f"{trader1_proposal[0] if trader1_proposal else '*Empty*'}"
        ),
        inline=True,
    )
    embed.add_field(
        ...
        value=(
            f"**{trader2.coins} {trader2_plural}**\n\n"
            f"{trader2_proposal[0] if trader2_proposal else '*Empty*'}"
        ),
        inline=True,
    )
