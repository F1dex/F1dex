...
spawn_messages_list = [
    ...
    f"Gentlemen, 30 years ago Niki Lauda told us, an {settings.collectible_name} has appeared.",
    "No, Kimi, no, you will not have the drink.",
    f"Oh no, I've caused an {settings.collectible_name} to appear.",
    ...
    (
        f"Tonight, I see an {settings.collectible_name} spawn, James overpays for "
    ...
    f"Through goes an {settings.collectible_name}!",
    f"Is it a boat? is it a plane? no, it's an {settings.collectible_name} spawn!",
    f"It's lights out, and an {settings.collectible_name} has appeared!",
